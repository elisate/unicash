...
const Notifications = ({ notifications = [] }) => {
  if (!notifications || notifications.length === 0) {
    return (
      <div
        className="w-[450px] p-4 rounded-lg bg-gray-200 shadow-md"
        style={{ maxHeight: "500px", overflowY: "auto" }}
      >
        <h2 className="text-lg font-semibold text-white bg-[#6B5540] p-2 rounded-t-lg">
          Notifications
        </h2>
  ...
  return (
    <div
      ...
      style={{ maxHeight: "500px", overflowY: "auto" }}
    >
      <h2 className="text-lg font-semibold text-white bg-[#6B5540] p-2 rounded-t-lg mb-4 sticky top-0 z-10">
        Notifications
      </h2>
      <div>
        {notifications.map((notification) => (
          <div
            key={notification.id}
            className="flex items-center justify-between p-3 mb-4 border-b border-gray-400"
          >
...
function App() {
  return (
    <div className="flex gap-12 p-2">
      ...
      <div className="mt-[-128px] mr-0 w-[450px] top[-128px]">
