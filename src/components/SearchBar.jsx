...
export default function Navbar() {
  ...
  return (
    <nav className="w-full max-w-screen-lg h-[77px] bg-white flex items-center justify-between px-4 sm:px-6 lg:px-8 sticky top-0 right-0 mx-auto z-0 border-b border-gray-300">
      {/* Left Section */}
