...
export default function Navbar() {
  ...
  return (
    <nav className="w-full max-w-screen-lg h-[77px] bg-white flex items-center justify-between px-4 sm:px-6 lg:px-8 right-0 mx-auto border-b border-gray-300 fixed top-0 left-0 ml-56 z-50 sm:ml-0 md:ml-40 lg:ml-56">
      {/* Left Section */}
